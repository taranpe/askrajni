...
export default function GemstonesCollection({ services }: Props) {
    ...
    <section className="py-8 bg-white">
      <div className="max-w-7xl mx-auto px-2">
        ...
        <div className="mb-5 text-center">
          <h1 className="text-3xl font-semibold">Gemstones Collection</h1>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-5">
          {services.map((item) => {
            ...
            return (
              <div
                key={item.id}
                onClick={() => !item.sold_out && router.push(`/services/${item.id}`)}
